            ...
            <div class="modal-body">
                <form action="<?= BASEURL;?>/mahasiswa/tambah" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama" placeholder="masukan nama mahasiswa"
                            name="nama">
                    </div>
                    <div class="form-group">
                        <label for="nama">nim</label>
                        <input type="number" class="form-control" id="nim" placeholder="masukan kelas mahasiswa"
                            name="nim">
                    </div>
                    <div class="form-group">
                        <label for="nama">kelas</label>
                        <input type="text" class="form-control" id="kelas" placeholder="masukan kelas mahasiswa"
                            name="kelas">
                    </div>
                    <div class="form-group">
